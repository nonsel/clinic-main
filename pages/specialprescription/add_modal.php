              ...
              <div class="modal-dialog modal-sm" style="width:700px !important;">
                <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Course:</label>
                                    <input name="txt_course" class="form-control input-sm" type="text" placeholder="Course"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-success btn-sm" name="btn_add" id="btn_add" value="Create Course"/>
                    </div>
                </div>
              </div>
              </form>
