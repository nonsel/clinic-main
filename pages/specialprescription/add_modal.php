                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="patient_id" class="form-control input-sm select2_patient" style="width:100%" required="">
                                    <?php
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <select name="supplier_id" class="form-control input-sm select2_supplier" style="width:100%" required="">
                                    <?php
