        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>Special Prescriptions Record</h1>
                </section>
                            ...
                            <div class="box-header">
                                <div style="padding:10px;">
                                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><i
                                            class="fa fa-user-plus" aria-hidden="true"></i> Add Special
...
include "../footer.php"; ?>
    <script type="text/javascript">
        ...
        $("#btn_download_pdf").click(function(){
            window.open('download_pdf.php?id='+edit_id,'_blank');
        });

        $(".select2_patient").val("").select2({
          placeholder: "Select Patient",
          allowClear: true
        });

        $(".select2_supplier").val("").select2({
