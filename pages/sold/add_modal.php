              ...
              <div class="modal-dialog modal-sm" style="width:300px !important;">
                <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Office:</label>
                                    <input name="txt_description" class="form-control input-sm" type="text" placeholder="Ex.: IRAD"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary btn-sm" name="btn_add" id="btn_add" value="Add Office"/>
                    </div>
                </div>
              </div>
              </form>
